...
<div class="min-h-screen relative">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 py-12">
    ...
    <!-- Header -->
    <div class="mb-8">
      <a href="index.php" class="text-yellow-400 hover:text-yellow-300 mb-6 inline-block">
        ← Voltar ao índice
      </a>

      <div class="flex justify-between">
        <div>
          <h1 class="text-5xl mb-2 text-yellow-400">CATEGORIAS</h1>
          <p class="text-gray-400">$ SELECT * FROM categorias ORDER BY nome;</p>
        </div>
      ...
      <table class="w-full">
        <thead>
          <tr class="border-b border-gray-800 bg-gray-900">
            ...
            <th class="px-6 py-4 text-left text-yellow-400">NOME</th>
            <th class="px-6 py-4 text-left text-yellow-400">DESCRIÇÃO</th>
            <th class="px-6 py-4 text-right text-yellow-400">PRODUTOS</th>
            <th class="px-6 py-4 text-center text-yellow-400">STATUS</th>
          </tr>
        </thead>

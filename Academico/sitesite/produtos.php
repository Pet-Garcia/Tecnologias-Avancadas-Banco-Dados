...
<div class="min-h-screen relative">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 py-12">
    ...
    <!-- Header -->
    <div class="mb-8">
      <a href="index.php" class="text-green-400 hover:text-green-300 mb-6 inline-block">
        ← Voltar ao índice
      </a>

      <div class="flex justify-between">
        <div>
          <h1 class="text-5xl mb-2 text-green-400">PRODUTOS</h1>
          <p class="text-gray-400">$ SELECT * FROM produtos ORDER BY nome ASC;</p>
        </div>
      ...
      <table class="w-full">
        <thead>
          <tr class="border-b border-gray-800 bg-gray-900">
            <th class="px-6 py-4 text-left text-green-400">SKU</th>
            <th class="px-6 py-4 text-left text-green-400">NOME</th>
            <th class="px-6 py-4 text-left text-green-400">CATEGORIA</th>
            <th class="px-6 py-4 text-right text-green-400">PREÇO</th>
            <th class="px-6 py-4 text-right text-green-400">ESTOQUE</th>
          </tr>
        </thead>

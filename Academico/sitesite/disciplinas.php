...
<div class="min-h-screen relative">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 py-12">
    ...
    <!-- Header -->
    <div class="mb-8">
      <a href="home.php" class="text-purple-400 hover:text-purple-300 mb-6 inline-block">
        ← Voltar a página ínicial
      </a>

      <div class="flex justify-between">
        <div>
          <h1 class="text-5xl mb-2 text-purple-400">DISCIPLINAS</h1>
          <p class="text-gray-400">$ SELECT * FROM disciplinas ORDER BY nome ASC;</p>
        </div>
      ...
      <table class="w-full">
        <thead>
          <tr class="border-b border-gray-800 bg-gray-900">
            ...
            <th class="px-6 py-4 text-left text-purple-400">NOME</th>
            <th class="px-6 py-4 text-right text-purple-400">IDCURSO</th>
            <th class="px-6 py-4 text-center text-purple-400">IDPROFESSOR</th>
          </tr>
        </thead>

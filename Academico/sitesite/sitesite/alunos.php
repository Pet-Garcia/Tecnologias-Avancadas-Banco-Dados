...
$alunos = []; // Aqui você pode puxar do banco depois
$total = count($alunos);
?>
...
<div class="min-h-screen relative">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 py-12">
    ...
    <!-- Header -->
    <div class="mb-8">
      <a href="home.php" class="text-cyan-400 hover:text-cyan-300 mb-6 inline-block">
        ← Voltar a página ínicial
      </a>

      <div class="flex justify-between">
        <div>
          <h1 class="text-5xl mb-2 text-cyan-400">ALUNOS</h1>
          <p class="text-gray-400">$ SELECT * FROM alunos LIMIT 100;</p>
        </div>
    ...
    switch($passo){
      case 0: {
    ?>
    <form method="POST" action="alunos.php" name="formaluno">
      <div class="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden">
        <table class="w-full">
          <thead>
            <tr class="border-b border-gray-800 bg-gray-900">
              <th class="px-6 py-4 text-left text-cyan-400">RA</th>
              <th class="px-6 py-4 text-left text-cyan-400">NOME</th>
              <th class="px-6 py-4 text-left text-cyan-400">CPF</th>
              <th class="px-6 py-4 text-left text-cyan-400">TELEFONE</th>
              <th class="px-6 py-4 text-left text-cyan-400">EMAIL</th>
            </tr>
          </thead>

          <tbody>
              <th class="px-6 py-4 text-left text-cyan-400"><input name="ra"></th>
              <th class="px-6 py-4 text-left text-cyan-400"><input name="nome"></th>
              <th class="px-6 py-4 text-left text-cyan-400"><input name="cpf"></th>
              <th class="px-6 py-4 text-left text-cyan-400"><input name="telefone"></th>
              <th class="px-6 py-4 text-left text-cyan-400"><input name="email"></th>
          </tbody>

          <tfooter>
          <tr><input type="hidden" value="1" name="passo">
            <td><button class="px-4 py-2 bg-cyan-500 text-black rounded">
                <input value="&lt;&lt; Limpar &gt;&gt;" type="reset">
              </button></td>
            <td><button class="px-4 py-2 bg-cyan-500 text-black rounded">
                <input value="&lt;&lt;  ON &gt;&gt;" type="submit">
              </button></td>
          </tr>
        </table>
      </div>
